...
type
  ...
  public
    ...
    Procedure GenerateXML(FeedType:TXMLTypeRSS);overload;
  ...
  published
    ...
    property XMLType: TXMLTypeRSS read FXMLType write FXMLType;
...
begin
  ...
  case FXMLType of
    xtRDFrss: aParser:=TSimpleParserRDF.Create(Self);
    xtRSSrss: aParser:=TSimpleParserRSS.Create(Self);
    xtAtomrss: aParser:=TSimpleParserAtom.Create(Self);
    xtiTunesrss : aParser := TSimpleParseriTunes.Create(Self);
  else
    aParser:=nil;
  end;
...
procedure TSimpleRSS.GenerateXML(FeedType: TXMLTypeRSS);
Var
  aParser : TSimpleParserBase;
begin
  Case FeedType of
