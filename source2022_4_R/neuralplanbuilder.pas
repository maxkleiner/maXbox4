...
type
  TState2 = array of byte;

type
  TProcPred = function(var ST: array of byte; Action: byte): boolean of object;

  Type TListActionsArr = array[0..MaxStates - 1] of byte;
       TListStatesArr =  array[0..MaxStates - 1] of TState2;
       //TPlansArray = array[0..MaxPlans - 1] of TPlan;
...
type
  ...
  TActionStateList = class
  protected
    FKeyCache: TABHash; // 1 in a given position might mean that the entry is there.

  public
    ListStates: TListStatesArr; //array[0..MaxStates - 1] of TState; // list of stored states.
    ListActions: TListActionsArr; //array[0..MaxStates - 1] of byte;   // list of action on state.
...
type
  ...
  public
    // List of plans.
    Plans: TPlansArray; //array[0..MaxPlans - 1] of TPlan;
