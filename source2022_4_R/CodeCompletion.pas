...
//    procedure GetTypeOfVar(_Value: string; var List, InhList: TIntList);
    function GetTypeID(_Value: string; il: TIntList2): integer;
    function ApplyStandardFilter(Index: integer): boolean;
    function ApplyClassFilter(Index, ParentID: integer; InheritanceIDs: TIntList2): boolean;
    function ApplyMemberFilter(_Class: string; Index, CurrentID: integer; ClassIDs, InheritanceIDs: TIntList2): boolean;
...
function TCodeCompletion.ApplyClassFilter(Index, ParentID: integer; InheritanceIDs: TIntList2): boolean;
begin
  Result :=
    (
...
function TCodeCompletion.ApplyMemberFilter(_Class: string; Index, CurrentID: integer; ClassIDs, InheritanceIDs: TIntList2): boolean;
var
...
begin
  bOnlyLocal := False;
  ClassIDs := TIntList2.Create;
  InheritanceIDs := TIntList2.Create;
...
function TCodeCompletion.GetTypeID(_Value: string; il: TIntList2): integer;
var
  I: integer;
begin
  Result := -1;
