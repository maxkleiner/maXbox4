...
type
  ...
  { TNeuronGroup }
  TNeuronGroup = class(TNeuronGroupBase)
  ...
  TClassifier = class (TStatePredictionClass)
  private
...
type
  ...
  TEasyLearnAndPredictClass = class
  private
