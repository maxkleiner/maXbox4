...
TYPE
  ...
  private
    ...
    PROCEDURE SetItems( i : INTEGER; Value : TModule);
  public
    PROPERTY Items[ i : INTEGER] : TModule read GetItems write SetItems;
  END;
...
CONSTRUCTOR TModule.Create( aOwner : tObjectList);
BEGIN
  INHERITED Create;
...
FUNCTION  TModuleList.GetItems( i : INTEGER) : TModule;
BEGIN
  Result:=TModule( INHERITED Items[ i]);
END;


PROCEDURE TModuleList.SetItems( i : INTEGER; Value : TModule);
BEGIN
