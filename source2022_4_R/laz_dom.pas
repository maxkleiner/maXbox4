...
// -------------------------------------------------------
  ...
  TXMLDocumentDOM = class(TDOMDocument)
  public
...
function TXMLDocumentDOM.CreateCDATASection(const data: DOMString):
  TDOMCDATASection;
begin
...
function TXMLDocumentDOM.CreateProcessingInstruction(const target,
  data: DOMString): TDOMProcessingInstruction;
begin
...
function TXMLDocumentDOM.CreateEntityReference(const name: DOMString):
  TDOMEntityReference;
begin
