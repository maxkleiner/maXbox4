...
type
  ...
  private
    ...
    fCurrentClass: TIntList2;
    fSkipList: TIntList2;
    fCurrentClassLevel: TIntList2;
...
begin
  ...
  fInvalidatedIDs := TIntList2.Create;
...
begin
  ...
  fCurrentClass := TIntList2.Create;
  fCurrentClassLevel := TIntList2.Create;
  fSkipList := TIntList2.Create;
