...
type
  TDelTreeProgress = function (const FileName: string; Attr: integer): Boolean;
...
begin
  JclSysUtils_max.LoadModule(_Kernel32Handle, kernel32);
