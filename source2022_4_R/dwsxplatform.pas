...
{                                                                      }
{    Current maintainer: Eric Grange  Max                              }
{                                                                      }
{**********************************************************************}
unit dwsXPlatform;
...
procedure SetDateSeparator(c : Char);
function GetDateSeparator : Char;
procedure SetTimeSeparator(c : Char);
function GetTimeSeparator : Char;
procedure SetThousandSeparator(c : Char);
function GetThousandSeparator : Char;
procedure SetListSeparator(c : Char);
function GetListSeparator : Char;

Procedure setShortDateFormat( c : string);
Function getShortDateFormat : string;
Procedure setlongDateFormat( c : string);
Function getlongDateFormat : string;
Procedure setShorttimeFormat( c : string);
Function getShorttimeFormat : string;
Procedure setlongtimeFormat( c : string);
...
begin
   {$IFDEF FPC}
      FormatSettings.DateSeparator:=c;
   {$ELSE}
      {$IF CompilerVersion >= 22.0}
      FormatSettings.DateSeparator:=c;
      {$ELSE}
...
begin
   {$IFDEF FPC}
      FormatSettings.TimeSeparator:=c;
   {$ELSE}
      {$IF CompilerVersion >= 22.0}
      FormatSettings.TimeSeparator:=c;
      {$ELSE}
...
begin
   {$IFDEF FPC}
      FormatSettings.longDateFormat :=c;
   {$ELSE}
      {$IF CompilerVersion >= 22.0}
      FormatSettings.longDateFormat:=c;
      {$ELSE}
...
begin
   {$IFDEF FPC}
      FormatSettings.ShortTimeFormat :=c;
   {$ELSE}
      {$IF CompilerVersion >= 22.0}
      FormatSettings.ShortTimeFormat:=c;
      {$ELSE}
...
begin
   {$IFDEF FPC}
      FormatSettings.longtimeFormat :=c;
   {$ELSE}
      {$IF CompilerVersion >= 22.0}
      FormatSettings.longtimeFormat:=c;
      {$ELSE}
...
begin
   {$IFDEF FPC}
      FormatSettings.ListSeparator:=c;
   {$ELSE}
      {$IF CompilerVersion >= 22.0}
      FormatSettings.ListSeparator:=c;
      {$ELSE}
