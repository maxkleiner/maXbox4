...
procedure SaveFile(const Contents, FileName: AnsiString;  Append: Boolean=false);
...
function IsClass(Address: TObject): Boolean; assembler;
asm
...
function IsObject(Address: TObject): Boolean; assembler;
asm
...
procedure SaveFile(const Contents: AnsiString; const FileName: AnsiString;  Append: Boolean);
var
  FS: TFileStream;
  Len: Integer;
begin
