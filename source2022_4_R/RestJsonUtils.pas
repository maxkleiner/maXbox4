unit RestJsonUtils;
//https://github.com/mcdavidg/Delphi-Utils/blob/main/UtilsTimeCode.pas
...
uses {$IFDEF SUPPORTS_GENERICS}RestJsonGenerics, {$ENDIF}
     ...
     SysUtils, DateUtils, TypInfo, Classes;
...
procedure FindFiles2List(StartDir, FileMask: string;
...
if (recursively) then
  ...
  // proteccion
    ...
    for i := 0 to DirList.Count - 1 do
      begin
      FindFiles2list(DirList[i], FileMask, recursively, FilesList);
      end;
