  ...
  revisions :     20.07.04 build menu structure
    ...
    locs=1974    V3.0 pop3, png, smtp, exceptionlog, emails, RegEX, sysutils
         ...
         11230          build 4.2.5.10 atom edit and 6 units more  hugeword RSA
          ...
          12221   4.7.6.10 VII neuronclass, QRCode, CAI bugs, commondelphi, AVXcheck, CAR console application runner, upsutils
...
begin
 ...
 try
   ...
   if (ParamStr(1) = '-c') then begin
         ...
         PSScript.Script.text:=  act_Filestring ;
...
begin
  ...
  maxForm1.Caption:= 'maXbox4 ScriptStudio  '+ExtractFilename(Act_Filename);
   ...
   if PSScript.Compile then begin
    ...
    stopw.Stop;
    memo2.Lines.Add(' mX4 executed: '+dateTimetoStr(Now())+
...
begin
  ...
  if not PSScript.Execute then begin
    ...
    stopw.Stop;
    memo2.Lines.Add(' mX4 run mode executed: '+dateTimetoStr(Now())+
