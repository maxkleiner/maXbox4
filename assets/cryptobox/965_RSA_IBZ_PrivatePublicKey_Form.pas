...
begin
 //object Main: TMain
  ...
  Caption := 'Informatik Sicherheit by maXbox4'
  ClientHeight := 707
  ClientWidth := 787
  Color := clMoneyGreen
  ...
  parent:= main;
    ...
    Width := 157
    Height := 13
    Caption := #169' Max Kleiner, El.Ing. BFH 2020'
  end;
