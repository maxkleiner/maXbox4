...
begin
  ...
  if phiN mod e = 0 then begin
    MessageDlg('PhiN darf nicht durch e teilbar sein, wähle andere Primzahlen "p/q"oder anderes "e"!', mtInformation,[mbOk], 0);
      exit;
    end;
...
begin
 //object Main: TMain
  ...
  Caption := 'Informatik Sicherheit by maXbox4 Scripting'
  ClientHeight := 707
  ClientWidth := 787
  Color := clMoneyGreen
  ...
  parent:= main;
    ...
    Width := 157
    Height := 13
    Caption := #169' Max Kleiner, BFH Mai 2020'
  end;
  ...
  parent:= main
    ...
    Width := 377
    Height := 100
    Caption := 'Zahl verschl'#252'sseln < N'
    Enabled := False
    TabOrder := 0
    ...
    parent:= groupbox5
      ...
      Width := 91
      Height := 13
      Caption := 'Zahl im Klartext "k"'
    end;
    Label22:= TLabel.create(main)
    ...
    parent:= groupbox5
      ...
      Width := 111
      Height := 13
      Caption := 'Verschl'#252'sselte Zahl "c"'
    end;
  ...
  parent:= main
     ...
     with groupbox1 do begin
      ...
      with label5 do begin
       parent:= groupbox1;
        ...
        Width := 287
        Height := 13
        Caption := 'Zahl "e" 3/17/65537 haben bin'#228'r wenig nullen, erh'#246'ht G'#252'te'
      end ;
      ...
      with label9 do begin
       parent:= groupbox1;
        ...
        Width := 167
        Height := 13
        Caption := 'phiN sollte nicht durch e teilbar sein'
      end;
    ...
    with groupbox3 do begin
      ...
      parent:= groupbox3;
        ...
        Width := 178
        Height := 13
        Caption := 'Public Key besteht aus n und e'
        Font.Charset := DEFAULT_CHARSET
        Font.Color := clWindowText
        Font.Height := -11
        Font.Name := 'MS Sans Serif'
      ...
      parent:= groupbox3;
        ...
        Width := 183
        Height := 13
        Caption := 'Private Key besteht aus n und d'
        Font.Charset := DEFAULT_CHARSET
        Font.Color := clWindowText
        Font.Height := -11
        Font.Name := 'MS Sans Serif'
    ...
    with groupbox4 do begin
      ...
      Width := 313
      Height := 127
      Caption := 'Primzahlen 1- 10'#39'000'
      TabOrder := 2
    ...
    parent:= groupbox6;
      ...
      Width := 180
      Height := 25
      Caption := '&Private Key d berechnen'
      Font.Charset := DEFAULT_CHARSET
      Font.Color := clWindowText
      Font.Height := -11
      Font.Name := 'MS Sans Serif'
    ...
    parent:= groupbox6;
      ...
      Width := 180
      Height := 25
      Caption := 'Unterbrechen und &Resultate zeigen'
      Enabled := False
      TabOrder := 4
  ...
  parent:= main
    ...
    Width := 377
    Height := 100
    Caption := 'Zahl entschl'#252'sseln'
    Enabled := False
    TabOrder := 2
 ...
 GroupBox10:= TGroupBox.create(main)
  ...
  parent:= main
    ...
    parent:= groupbox10
      ...
      Width := 177
      Height := 41
      Caption := 'Formel verschl'#252'sseln'
      TabOrder := 1
    ...
    parent:= groupbox10
      ...
      Width := 177
      Height := 41
      Caption := 'Formel entschl'#252'sseln'
      TabOrder := 2
...
var message, s_encrypt, s_decrypt: string;
    hexmess, bigstr2, __e, __n, __d: string;
    var abig: TInteger;
        bigstr: TBytes;
        time1: TTime;
...
if LoadDFMFile2Strings('C:\maXbox\softwareschule\IBZ_2016\IBZ_IT_Security_2016\DVD Inhalt\RSA Berechnung\PrivateKey.dfm',srlist, abt)= 0 then
 ...
 { bignumbertesthex;
  ...
  //Pivot from umatrix
    ...
    println(sha1('C:\maXbox\softwareschule\IBZ_2016\IBZ_ITSEC_2019\maxbox4\maxbox4\firstdemo.txt_decrypt'));
