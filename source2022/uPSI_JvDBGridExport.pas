...
begin
  ...
  with CL.AddClassN(CL.FindClass('TJvCustomDBGridTextExport'),'TJvDBGridXMLExport') do begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TJvCustomDBGridTextExport'),'TJvDBGridHTMLExport') do begin
    RegisterMethod('Constructor Create( AOwner : TComponent)');
         RegisterMethod('Procedure Free');
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TJvCustomDBGridOleExport'),'TJvDBGridExcelExport') do begin
    RegisterMethod('Constructor Create( AOwner : TComponent)');
         RegisterMethod('Procedure Free');
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TJvCustomDBGridOleExport'),'TJvDBGridWordExport') do begin
    RegisterMethod('Constructor Create( AOwner : TComponent)');
         RegisterMethod('Procedure Free');
     RegisterProperty('Close', 'TOleServerClose', iptrw);
...
procedure RIRegister_TJvDBGridXMLExport(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TJvDBGridXMLExport) do begin
    RegisterConstructor(@TJvDBGridXMLExport.Create, 'Create');
       RegisterMethod(@TJvDBGridXMLExport.Destroy, 'Free');
  end;
end;
...
begin
  with CL.Add(TJvDBGridHTMLExport) do begin
    RegisterConstructor(@TJvDBGridHTMLExport.Create, 'Create');
       RegisterMethod(@TJvDBGridHTMLExport.Destroy, 'Free');
...
begin
  with CL.Add(TJvDBGridExcelExport) do begin
    RegisterConstructor(@TJvDBGridExcelExport.Create, 'Create');
       RegisterMethod(@TJvDBGridExcelExport.Destroy, 'Free');
...
begin
  with CL.Add(TJvDBGridWordExport) do begin
    ...
    RegisterMethod(@TJvDBGridWordExport.Destroy, 'Free');
