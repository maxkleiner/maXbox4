...
procedure TAPPLICATIONMainFormOnTaskBar_R(Self: TAPPLICATION; var T: BOOLEAN); begin T := Self.MainFormOnTaskBar; end;
procedure TAPPLICATIONMainFormOnTaskBar_W(Self: TAPPLICATION; T: BOOLEAN); begin Self.MainFormOnTaskBar := T; end;
...
begin
 ...
 {$ENDIF}
    ...
    RegisterPropertyHelper(@TAPPLICATIONMainFormOnTaskBar_R, @TAPPLICATIONMainFormOnTaskBar_W,'MainFormOnTaskBar');
