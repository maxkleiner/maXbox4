unit uPSI_Chart;
{
  ...
  find bug of series - tcustomaxiaspanel   - add gradient - backwall
}
interface
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TCustomChart'),'TChart') do begin
    ...
    RegisterProperty('SeriesList','TChartSerieslist',iptrw);
    RegisterProperty('SeriesList','TChartSerieslist',iptrw);
    RegisterProperty('Shadow','TTeeShadow',iptrw);
    RegisterProperty('Tools','TChartTools',iptrw);
    ...
    //RegisterProperty('CANVAS', 'TTeeCanvas', iptrw);
    //RegisterProperty('Gradient', 'TTeeGradient', iptrw);
    ...
    RegisterProperty('BevelWidth', 'Integer', iptrw);
     RegisterProperty('AllowPanning', 'boolean', iptrw);
    //ScrollMouseButton
    {property MarginBottom;
    property MarginLeft;  AllowPanning
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TCustomAxisPanel'),'TCustomChart') do begin
   ...
   // RegisterProperty('Series', 'TCustomAxisPanel', iptrw);
    // RegisterProperty('CANVAS', 'TTeeCanvas', iptrw);
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TPersistent'),'TChartWalls') do begin
...
begin
  ...
  begin
     ...
     RegisterProperty('FONT', 'TTEEFont', iptrw);
     RegisterProperty('Transparent', 'Boolean', iptrw);
      RegisterProperty('Transparency', 'integer', iptrw);
    RegisterProperty('Brush', 'TChartBrush', iptrw);
      RegisterProperty('Pen', 'TChartPen', iptrw);
   // RegisterProperty('Font', 'TTeeFont', iptrw);
    RegisterProperty('Color', 'TColor', iptrw);
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TTeeCustomShapePosition'),'TCustomChartLegend') do begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TList'),'TLegendItems') do
  begin
    RegisterMethod('Procedure Clear');
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TPersistent'),'TLegendItem') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TTeeShape'),'TLegendTitle') do begin
    RegisterMethod('Constructor Create( AOwner : TCustomTeePanel)');
    RegisterMethod('Procedure Assign( Source : TPersistent)');
       RegisterMethod('Procedure Free;');
     RegisterProperty('Caption', 'String', iptrw);
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TChartGradient'),'TChartLegendGradient') do begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TCustomChartWall'),'TChartWall') do begin
    registerpublishedproperties;
       RegisterProperty('Brush', 'TChartBrush', iptrw);
      RegisterProperty('Pen', 'TChartPen', iptrw);
...
begin
 ...
 CL.AddConstantN('TeeTitleFootDistance','LongInt').SetInt( 5);
  ...
  //  TComponentName = type string; of classes
  ...
  CL.AddTypeS('TOnGetLegendPos', 'Procedure ( Sender : TCustomChart; Index : Integer; var X, Y, XColor : Integer)');
...
procedure TCustomChartSeries_W(Self: TCustomChart; const T: TChartSeries; const t1: Integer);
begin //Self.series[t1]:= T;
end;
...
(*----------------------------------------------------------------------------*)
procedure TCustomChartSeries_R(Self: TCustomChart; var T: TChartSeries; const t1: Integer);
begin T := Self.Series[t1]; end;
...
begin
  with CL.Add(TChartTheme) do begin
    ...
    RegisterConstructor(@TChartThemeCreate_P, 'Create');
...
procedure RIRegister_TColorPalettes(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TColorPalettes) do begin
...
(*----------------------------------------------------------------------------*)
procedure TChartParent_W(Self: TChart; const T: TWincontrol);
begin Self.parent:= T; end;

(*----------------------------------------------------------------------------*)
procedure TChartParent_R(Self: TChart; var T: TWinControl);
begin T:= Self.Parent; end;

(*----------------------------------------------------------------------------*)
procedure TChartFont_W(Self: TChart; const T: TTeeGradient);
begin Self.gradient:= T; end;

(*----------------------------------------------------------------------------*)
procedure TChartFont_R(Self: TChart; var T: TTeeGradient);
begin T:= Self.gradient; end;
...
procedure RIRegister_TChart(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TChart) do begin
     RegisterPropertyHelper(@TChartParent_R,@TChartParent_W,'Parent');
     RegisterPropertyHelper(@TChartfont_R,@TChartfont_W,'Gradient');
...
begin
  with CL.Add(TCustomChart) do begin
   ...
   RegisterMethod(@TCustomChart.Assign, 'Assign');
    ...
    RegisterPropertyHelper(@TCustomChartSeries_R,@TCustomChartSeries_W,'Series');
...
begin
  with CL.Add(TChartWalls) do begin
    RegisterConstructor(@TChartWalls.Create, 'Create');
       RegisterMethod(@TChartWalls.Destroy, 'Free');
...
(*----------------------------------------------------------------------------*)
procedure TChartTitleGradient_W(Self: TLegendSymbol; const T: TTeeGradient);
begin Self.Gradient := T; end;

(*----------------------------------------------------------------------------*)
procedure TChartTitleGradient_R(Self: TLegendSymbol; var T: TTeeGradient);
begin T := Self.Gradient; end;

procedure TCharttitleFont_W(Self: TCharttitle; const T: TTeeFont);
begin Self.font:= T; end;

(*----------------------------------------------------------------------------*)
procedure TCharttitleFont_R(Self: TCharttitle; var T: TTeeFont);
...
begin
  with CL.Add(TChartTitle) do begin
    RegisterConstructor(@TChartTitle.Create, 'Create');
       RegisterMethod(@TChartTitle.Destroy, 'Free');
    ...
    RegisterMethod(@TChartTitle.DrawTitle, 'DrawTitle');
     RegisterPropertyHelper(@TChartTitleGradient_R,@TChartTitleGradient_W,'Gradient');
      RegisterPropertyHelper(@TCharttitlefont_R,@TCharttitlefont_W,'Font');
...
(*----------------------------------------------------------------------------*)
procedure TChartLegendGradient_W(Self: TLegendSymbol; const T: TTeeGradient);
begin Self.Gradient := T; end;

(*----------------------------------------------------------------------------*)
procedure TChartLegendGradient_R(Self: TLegendSymbol; var T: TTeeGradient);
begin T := Self.Gradient; end;

procedure TChartlegendFont_W(Self: TChartlegend; const T: TTeeFont);
begin Self.font:= T; end;

(*----------------------------------------------------------------------------*)
procedure TChartlegendFont_R(Self: TChartlegend; var T: TTeeFont);
begin T:= Self.font; end;
...
procedure RIRegister_TChartLegend(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TChartLegend) do begin
       RegisterPropertyHelper(@TChartLegendGradient_R,@TChartLegendGradient_W,'Gradient');
       RegisterPropertyHelper(@TChartLegendfont_R,@TChartLegendfont_W,'Font');
  end;
end;
...
begin
  with CL.Add(TCustomChartLegend) do begin
    ...
    RegisterConstructor(@TCustomChartLegend.Create, 'Create');
       RegisterMethod(@TCustomChartLegend.Destroy, 'Free');
...
begin
  with CL.Add(TLegendTitle) do begin
    RegisterConstructor(@TLegendTitle.Create, 'Create');
       RegisterMethod(@TLegendTitle.Destroy, 'Free');
...
begin
  with CL.Add(TLegendSymbol) do begin
    ...
    RegisterConstructor(@TLegendSymbol.Create, 'Create');
       RegisterMethod(@TLegendSymbol.Destroy, 'Free');
...
begin
  with CL.Add(TCustomChartWall) do begin
    ...
    RegisterMethod(@TCustomChartWall.Assign, 'Assign');
       RegisterMethod(@TCustomChartWall.Destroy, 'Free');
