...
code implementing the class wrapper is fpr mX3 Win & Linux
 ...
 All: jvjclutils/jvctrutils/jvvclutils/dbtables/db/
  ...
  //APPCOMMAND Shell Consts 3.9.9.80     locs 4311
   ...
   // fix getrvalue bug    getform2      - 4322 LOADFORM2 external   loadtextfromfile 4.7.6.10
...
function loadForm2(vx, vy: smallint; acolor: TColor; aname: string): TForm;
begin
  //psize:= vx*vy
  //constructor
  result:= Tform.create(Nil);
...
function QueryPerformanceCounter2(var aC: Int64): boolean;
//var //T: TLargeInteger;
begin
  result:= QueryPerformanceCounter(aC);
  //CardinalsToI64(C, T.LowPart, T.HighPart);
end;
  ...
  { TMessage = packed record
    ...
    case Integer of
      0: (           WParam: Longint;
        ...
        Result: Longint);
      1: (           WParamLo: Word;
        WParamHi: Word;  LParamLo: Word;
        LParamHi: Word;  ResultLo: Word;
        ResultHi: Word);
  end;}
...
// CL.AddDelphiFunction('Function StringToWideChar( const Source : string; Dest : PWideChar; DestSize : Integer) : PWideChar');
 ...
 CL.AddDelphiFunction('function queryPerformanceCounter2(var mse: int64): boolean;');
 CL.AddDelphiFunction('function QueryPerformanceFrequency(var lfreq: int64): boolean; stdcall;');
 //CL.AddDelphiFunction('function QueryPerformanceCounterbool(var lcount: Int64): boolean');
...
// CL.AddDelphiFunction('Function CreateBrushIndirect( const p1 : TLogBrush) : HBRUSH');
 ...
 CL.AddDelphiFunction('function getForm2(vx, vy: smallint; acolor: TColor; aname: string): TForm;');
...
S.RegisterDelphiFunction(@queryPerformanceCounter2, 'queryPerformanceCounter2',cdRegister);
...
//S.RegisterDelphiFunction(@queryPerformanceCounterbool, 'queryPerformanceCounterbool',CdRegister);
...
// S.RegisterDelphiFunction(@DomToTree, 'DomToTree', CdRegister);
 ...
 S.RegisterDelphiFunction(@loadForm2, 'getForm2', CdRegister);
 S.RegisterDelphiFunction(@loadForm2, 'loadForm2', CdRegister);
