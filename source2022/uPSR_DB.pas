...
with Cl.Add(TPARAMS) do begin
 RegisterConstructor(@TPARAMS.Create, 'Create');
 //RegisterConstructor(@TPARAMS.Create, 'Create1');
...
with Cl.Add(TPARAM) do
  ...
  RegisterMethod(@TPARAM.ASSIGN, 'ASSIGN');
    RegisterMethod(@TPARAM.CLEAR, 'CLEAR');
  RegisterConstructor(@TPARAM.Create, 'Create');
