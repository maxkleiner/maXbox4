...
connect to ADO with wideStrings by max
  in 3.9.6 SQL.add of widestring solved!, more create, free, assign, exec
   ...
   add _recordsetintf 4.2.8.10!   source/REST unit uPSI_ADOInt;
}
interface
...
begin
  ...
  CL.AddTypeS('TParameterDirection', '( pdUnknown, pdInput, pdOutput, pdInputOutput, pdReturnValue )');
...
{procedure TDATASETBOOKMARK_R(Self: TCustomADODataSet; var T: Bookmark);
