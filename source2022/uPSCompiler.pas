...
// mX4.2.4.25    - mX4.7.1.80   - mX4.7.2.82   - mX4.7.6.10
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if Parser.CurrTokenId = CSTII_Const then
          begin
            VCType := FindAndAddType(Owner, '!OPENARRAYOFCONST', 'array of _Pointer2')
          end
          else begin
...
begin
  ...
  at2ut(AddType('_Pointer2', btPointer));

  //AddType('___Pointer', btPointer);
  //AddType('___Pointer', btstring);
  at2ut(AddType('___Pointer', btstring));
  AddType('_Pointer', btPointer);
  AddType('_Ptr2', btPointer);
  AddType('bigintmax', btS64);
  AddType('maxbigint', btS64);
  AddType('maxchar2', btWideChar);

  //AddType('_Pointerback', btReturnAddress);
