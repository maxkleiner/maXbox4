...
as an OpenToolsAPI to modify the maXbox GUI - V3.5 -V3.8.6 , version check
  ...
  MBVERIALL, ResetKeyPressed, arduino items, terminal;    4.2.2.90  /95  /98  42425 4.2.4.60  4.2.5.10 42610 42810
                      45810 46210 46310 47110 47120 47180 47182 47282 47360 47460 47462 47464 47520 47580 47590 47620}
...
begin
 ...
 CL.AddConstantN('MBVERSION','String').SetString('4.7.6.20');
 CL.AddConstantN('VERSION','String').SetString('4.7.6.20');
 CL.AddConstantN('MBVERIALL','Integer').SetInt(47620);
 CL.AddConstantN('MBVER2','String').SetString('47620');
