  ...
  revisions :     20.07.04 build menu structure
    ...
    locs=1974    V3.0 pop3, png, smtp, exceptionlog, emails, RegEX, sysutils
         ...
         11230          build 4.2.5.10 atom edit and 6 units more  hugeword RSA
          ...
          13245   5.2.7.120 May 2025 D12.1 plus 20 units  - python 3.13, 3.14 integration P4D
...
const
   ...
   MBVERSION = '5.2.7.120';
   MBVER = '527';              //for checking!
   MBVER2 = '527120';              //for checking!
   EXENAME ='maXbox5.exe';
...
begin
  ...
  if STATExceptionLog then begin
   ...
   maxform1.Caption:= 'maXbox52 Ocean1050 mX527 XRheingold+++++ beta520!';
