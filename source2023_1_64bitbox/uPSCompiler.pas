...
// mX4.2.4.25    - mX4.7.1.80   - mX4.7.2.82   - mX4.7.6.10  - mX4.7.6.20 - mX5.1.4.98
...
begin
 ...
 //  AddFunction('function StrToFloat(s: String): Extended;');
  ...
  AddFunction('Function Bo2Str(aBool: boolean): string;');
  AddFunction('function BoolToStr(B: Boolean; UseBoolStrs: Boolean): string;');
  ...
  //by max
   AddFunction('function IntToHex(a: integer; b: integer): string;');
    AddFunction('function Int2Hex(a: integer; b: integer): string;');
  ...
  //AddFunction('function DateTimeToStr(datetime: extended): string;');
   ...
   AddFunction('Function DateTimeToStr( DateTime : double) : string;');  //*)
   AddFunction('Function DateTime2Str( DateTime : double) : string;');  //*)
   AddFunction('function GetTextFromFile(Filename : String) : string;');
    AddFunction('function GetTextFromFile2(Filename : ansiString) : ansistring;');
    AddFunction('function GetTextFromFile3(Filename : ansiString) : string;');
    AddFunction('Function x2CreateOleObject( const ClassName : string) : Variant');
   AddFunction('Function psStringReplace(Const aValue: String; aOldPattern: String; aNewPattern: String): String;');
  //AddFunction('function mFormat(const Format: string; const Args: array of const): string;') ;
  //*)
