...
type
  TMaxForm1 = class(TForm)
    ...
    procedure cedebugBreakpoint(Sender: TObject; const FileName: ansiString;
    ...
    procedure cedebugLineInfo(Sender: TObject; const FileName: ansiString;
      Position, Row, Col: Cardinal);
...
uses
  uPSR_std,
  uPSC_std,          //TObject!   TComponent  Trect
  uPSR_stdctrls,
...
(*  uPSI_JvJoystick,
 ...
 (* uPSI_JclIniFiles,
  ...
  uPSI_DebugBox,
  uPSI_ustrings,
  uPSI_uregtest,   //last before Form less
  uPSI_usimplex,
  uPSI_uhyper,
  uPSI_unlfit,
  uPSI_ExtPascalUtils,
(*  uPSI_SocketsDelphi,
 ...
 (* uPSI_SynEditHighlighter,
  ...
  //SvcMgr,      // fix application namespace
  uPSI_ImageWin,
...
(*  uPSI_synacrypt,
 ...
 (* uPSI_VariantRtn,
  ...
  uPSI_MaxStrUtils,
 //uPSI_MaxXMLUtils,
  uPSI_MaxUtils,             //64 units add in V4
  uPSI_VListBox,
 // uPSI_MaxDOM,
...
begin
  ...
  //psscript.AddRegisteredVariable('FormatSettings','TFormatSettings');
  //PSScript.SetVarToInstance('formatsettings',formatsettings);
...
begin
  ...
  memo2.Lines.Add('XCompiler Scripz: '+memo1.text);
  //showmessage(psscript.script.Text);
