...
#sign:Max: MAXBOX10: 18/05/2016 09:37:45 
...
takes place. Just play around a bit. #locs:894
}
interface
...
{------------------------------------------------------------------------------}
procedure FillPlotSquare(pts: double);
var i,j : LongInt;
    a   : TGraphLine;
    f,g : Single;
    ptX, ptY : Single;
...
begin
  ...
  FillPlotSquare(0.25); //puts cute values into Array2D
...
begin
  ...
  //preparechessBoard;
   ...
   //plot.onscroll;
    //For it:= 0 to Array2D.Count-10 do
      //Plot.AddLine(TGraphLine(Array2D[it+4]));
