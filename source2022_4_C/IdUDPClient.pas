...
type
  ...
  TIdUDPClient = class(TIdUDPBase)
    ...
    //procedure SendBufferAB(var ABuffer: array of byte; const AByteCount: integer); overload;
	published
...
{procedure TIdUDPClient.SendBufferAB(var ABuffer: array of byte; const AByteCount: integer);
begin
  SendBuffer(Host, Port, ABuffer, AByteCount);
end;}
