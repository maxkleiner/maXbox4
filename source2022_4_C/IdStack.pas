...
{function TIdStack.HostToNetwork2(AValue: TIdIPv6Address): TIdIPv6Address;
var i : Integer;
begin
...
begin
  //for i := 0 to 7 do begin
    //Result[i]:= Gstack.HostToNetwork(AValue[i]);
    Result:= Gstack.HostToNetwork(AValue);
...
begin
  //for i := 0 to 7 do begin
    //Result[i]:= Gstack.NetworkToHost(AValue[i]);
  //for i:= 0 to 7 do begin
    Result:= Gstack.NetworkToHost(AValue);
//end;
end;
