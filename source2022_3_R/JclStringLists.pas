...
type
  ...
  IJclStringList = interface(IInterface)
    ...
    {$ELSE}
    function ExtractWords(const AText: string; const ADelims: TsysCharset = [#0..' ']; AClearBeforeAdd: Boolean = True): IJclStringList;
    {$ENDIF CLR}
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jcl.svn.sourceforge.net/svnroot/jcl/tags/JCL-1.102-Build3072/jcl/source/common/JclStringLists.pas $';
...
function TJclStringListImpl.ExtractWords(const AText: string; const ADelims: TSyscharset;
