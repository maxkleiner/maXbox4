...
begin
  ...
  with CL.AddClassN(CL.FindClass('TIdAuthentication'),'TIdBasicAuthentication') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TPersistent'),'TIdAuthentication') do
  begin
    RegisterMethod('Constructor Create');
    RegisterMethod('Procedure Reset');
    RegisterMethod('Function Authentication : String');
...
procedure SIRegister_IdAuthentication(CL: TPSPascalCompiler);
begin
  CL.AddTypeS('TIdAuthenticationSchemes', '( asBasic, asDigest, asNTLM, asUnkno'
   +'wn )');
...
procedure RIRegister_TIdBasicAuthentication(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TIdBasicAuthentication) do
  begin
...
procedure RIRegister_TIdAuthentication(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TIdAuthentication) do
  begin
    RegisterVirtualConstructor(@TIdAuthentication.Create, 'Create');
