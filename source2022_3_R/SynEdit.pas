...
//### Code Folding ###
  ...
  //messagebox(hinstance,'syn','syn',MB_ICONEXCLAMATION);
  ...
  try
    ...
    begin
      ...
      begin
        ...
        Inc(xpos);
				arect.Top := (cLine - fTopLine) * LineHeight;
				arect.Bottom := arect.Top + LineHeight;
				arect.Left := xpos;
				arect.Right := xpos + Gutter.RightOffset - 4;
        ...
        begin
					x := arect.Left + ((arect.Right - arect.Left) div 2);
					Canvas.MoveTo(x, arect.Top);
					Canvas.LineTo(x, arect.Top + ((arect.Bottom - arect.Top) div 2));
					Canvas.LineTo(arect.Right - 2, arect.Top + ((arect.Bottom - arect.Top) div 2));
				end;
        ...
        begin
        	...
        	// http://mystix.projects.waterproof.fr/IssueView.php?Id=8
      		...
      		begin
						...
						arect.Top := arect.Top + ((LineHeight - H) div 2);
            ...
            begin
            	...
            	Canvas.Brush.Color := clWindow;
						...
						// Paint minus sign
						Canvas.Pen.Color := CodeFolding.FolderBarLinesColor;
						Canvas.MoveTo(arect.Left + 2, arect.Top + ((arect.Bottom - arect.Top) div 2));
						Canvas.LineTo(arect.Right - 2, arect.Top + ((arect.Bottom - arect.Top) div 2));

						if FoldRange.Collapsed then
        		begin
							// Paint plus sign
							Canvas.MoveTo(arect.Left + ((arect.Right - arect.Left) div 2), arect.Top + 2);
							Canvas.LineTo(arect.Left + ((arect.Right - arect.Left) div 2), arect.Bottom - 2);
						end;
					end;
        end;
      end;
