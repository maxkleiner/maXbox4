unit uPSI_ADOInt;
{
This file has been generated get a second one!!
}
interface
...
begin
  ...
  begin
    RegisterMethod('Function Get_Properties : Properties', CdStdCall);
  end;
end;
...
begin
 ...
 CL.AddConstantN('adRecalcAlways','LongWord').SetUInt( $00000001);
  ...
  CL.AddInterface(CL.FindInterface('IUNKNOWN'),_ADO, '_ADO');
  ...
  CL.AddInterface(CL.FindInterface('IUNKNOWN'),Recordset20, 'Recordset20');
