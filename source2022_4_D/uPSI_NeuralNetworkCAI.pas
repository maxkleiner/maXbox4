...
{
mymymneuralnet  TNNetLayerFullConnectReLU  fix virtual constructor  and virtual method

   maxForm1.memo2.lines.Add('Debug structuretostring: '+result);
 savestructuretostring 1--8 to large     - TNNetReLUBase bugfix     AddDenseNetBlockCAI72
...
procedure RIRegister_neuralnetworkCAI(CL: TPSRuntimeClassImporter);
...
begin
  ...
  begin
    ...
    RegisterMethod('Procedure Compute2( var pInput : TBytes)');
    RegisterMethod('Procedure Backpropagate( var pOutput : array of byte)');
    RegisterMethod('Procedure Backpropagate2( var pOutput : TBytes)');
    RegisterMethod('Procedure GetOutput( var pOutput : array of byte)');
    RegisterMethod('Procedure GetOutput2( var pOutput : TBytes)');
  end;
end;
...
begin
  ...
  begin
    ...
    RegisterMethod('Function AddDenseNetBlockCAI70( pUnits, k, supressBias : integer; PointWiseConv : TNNetConvolutionLinear; IsSeparable : boolean; HasNorm : boolean; pBefore : TNNetLayerClass; pAfter : TNNetLayerClass; ' +
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TMObject'),'TNNet') do begin
    RegisterMethod('Constructor Create( )');
    RegisterMethod('Procedure Free;');
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TNNetLocalConnect'),'TNNetLocalConnectReLU') do begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TNNetConvolution'),'TNNetConvolutionLinear') do begin
    RegisterMethod('constructor Create(pNumFeatures, pFeatureSize, pInputPadding, pStride: integer; pSuppressBias: integer)'); //; override;
...
begin
  ...
  begin
    RegisterMethod('Constructor Create(pNumFeatures, pFeatureSize, pInputPadding, pStride, pGroups: integer; pSuppressBias: integer)');
...
begin
  ...
  begin
    ...
    RegisterMethod('Constructor Create( LowValue, HighValue : integer);');
    RegisterMethod('Procedure Compute( )');
    RegisterMethod('Procedure Backpropagate( )');
  end;
end;
...
begin
 ...
 CL.AddTypeS('TNNetLayerClass', 'TObject');          //alias
 CL.AddTypeS('TNNetConvolutionClass', 'TObject');

 //TNNetConvolutionClass
 ...
 CL.AddDelphiFunction('procedure TestBackProp();');
...
Function THistoricalNetsAddDenseNetBlockCAI70_P(Self: THistoricalNets;  pUnits, k, supressBias : integer; PointWiseConv : TNNetConvolutionLinear; IsSeparable : boolean; HasNorm : boolean; pBefore : TNNetLayerClass; pAfter : TNNetLayerClass; BottleNeck : integer; Compression : integer; DropoutRate : TNeuralFloat; RandomBias : integer; RandomAmplifier : integer; FeatureSize : integer) : TNNetLayer;
Begin Result := Self.AddDenseNetBlockCAI70(pUnits, k, supressBias, PointWiseConv, IsSeparable, HasNorm, pBefore, pAfter, BottleNeck, Compression, DropoutRate, RandomBias, RandomAmplifier, FeatureSize); END;
...
begin
 ...
 S.RegisterDelphiFunction(@TestBackProp, 'TestBackProp', cdRegister);
...
begin
  ...
  begin
    RegisterConstructor(@TEasyBytePredictionViaNNet.Create, 'Create');
     RegisterMethod(@TEasyBytePredictionViaNNet.Destroy, 'Free');
  end;
end;
...
begin
  ...
  begin
    ...
    RegisterMethod(@TBytePredictionViaNNet.Destroy, 'Free');
...
begin
  ...
  begin
    RegisterConstructor(@TNNetForByteProcessing.Create, 'Create');
     RegisterMethod(@TNNetForByteProcessing.Destroy, 'Free');
    ...
    RegisterMethod(@TNNetForByteProcessing.Compute, 'Compute2');
    RegisterMethod(@TNNetForByteProcessing.Backpropagate, 'Backpropagate');
    RegisterMethod(@TNNetForByteProcessing.Backpropagate2, 'Backpropagate2');
    RegisterMethod(@TNNetForByteProcessing.GetOutput, 'GetOutput');
     RegisterMethod(@TNNetForByteProcessing.GetOutput2, 'GetOutput2');
  end;
end;
...
begin
  ...
  begin
    RegisterConstructor(@TNNetByteProcessingCreate76_P, 'Create76');
      RegisterMethod(@TNNetByteProcessing.Destroy, 'Free');
...
begin
  ...
  begin
    ...
    RegisterMethod(@THistoricalNetsAddDenseNetBlockCAI70_P, 'AddDenseNetBlockCAI70');
...
begin
  ...
  begin
    ...
    RegisterMethod(@TNNet.Destroy, 'Free');
    ...
    RegisterMethod(@TNNetAddLayer47_P, 'AddLayer');
    RegisterMethod(@TNNetAddLayer48_P, 'AddLayer1');
    RegisterMethod(@TNNetAddLayer49_P, 'AddLayer2');
    ...
    RegisterMethod(@TNNet.ShouldIncDepartingBranchesCnt, 'ShouldIncDepartingBranchesCnt');
...
begin
  ...
  begin
    ...
    RegisterMethod(@TNNetPoolBase.Destroy, 'Free');
  end;
end;
...
procedure RIRegister_TNNetLocalConnectReLU(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TNNetLocalConnectReLU) do  begin
...
begin
  ...
  begin
    RegisterConstructor(@TNNetPointwiseConv.Create, 'Create');
  end;
end;
...
procedure RIRegister_TNNetConvolutionLinear(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TNNetConvolutionLinear) do begin
...
begin
  ...
  begin
    ...
    RegisterConstructor(@TNNetConvolutionSharedWeightsCreate39_P, 'Create39');
  end;
end;
...
begin
  ...
  begin
    RegisterConstructor(@TNNetGroupedPointwiseConvLinear.Create, 'Create');
  end;
end;
...
procedure RIRegister_TNNetGroupedConvolutionReLU(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TNNetGroupedConvolutionReLU) do begin
  RegisterConstructor(@TNNetGroupedConvolutionReLU.Create, 'Create');
  end;
end;
...
begin
  ...
  begin
    RegisterConstructor(@TNNetGroupedConvolutionLinearCreate37_P, 'Create37');
...
begin
  ...
  begin
    RegisterConstructor(@TNNetConvolutionBaseCreate36_P, 'Create36');
...
begin
  ...
  begin
    ...
    RegisterConstructor(@TNNetDepthwiseConvCreate33_P, 'Create33');
...
begin
  ...
  begin
    RegisterConstructor(@TNNetFullConnectCreate26_P, 'Create26');
    RegisterConstructor(@TNNetFullConnectCreate27_P, 'Create27');
    RegisterMethod(@TNNetFullConnect.Compute, 'Compute');
    RegisterMethod(@TNNetFullConnect.ComputeCPU, 'ComputeCPU');
    RegisterMethod(@TNNetFullConnect.Backpropagate, 'Backpropagate');
    RegisterMethod(@TNNetFullConnect.BackpropagateCPU, 'BackpropagateCPU');
...
begin
  ...
  begin
    ...
    RegisterMethod(@TNNetDropout.Destroy, 'Free');
...
procedure RIRegister_TNNetReLU(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TNNetReLU) do begin
...
begin
  ...
  begin
    ...
    RegisterConstructor(@TNNetDigitalCreate7_P, 'Create');
...
begin
  ...
  begin
    ...
    //RegisterConstructor(@TNNetReLUBase.create, 'Create');
  end;
end;
...
begin
  ...
  begin
    ...
    RegisterMethod(@TNNetLayer.Destroy, 'Free');
    ...
    RegisterMethod(@TNNetLayer.ComputeOutputErrorWith, 'ComputeOutputErrorWith');
    RegisterMethod(@TNNetLayer.ComputeOutputErrorForIdx, 'ComputeOutputErrorForIdx');
    ...
    RegisterMethod(@TNNetLayer.CopyWeights, 'CopyWeights');
    RegisterMethod(@TNNetLayer.ForceRangeWeights, 'ForceRangeWeights');
    RegisterMethod(@TNNetLayer.NormalizeWeights, 'NormalizeWeights');
    RegisterMethod(@TNNetLayer.SaveDataToString, 'SaveDataToString');
    RegisterMethod(@TNNetLayer.LoadDataFromString, 'LoadDataFromString');
    RegisterMethod(@TNNetLayer.SaveStructureToString, 'SaveStructureToString');
    ...
    RegisterMethod(@TNNetLayer.InitDefault, 'InitDefault');
...
begin
  ...
  begin
    ...
    RegisterMethod(@TNNetNeuron.Destroy, 'Free');
