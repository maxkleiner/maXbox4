...
begin
  ...
  with CL.AddClassN(CL.FindClass('TCustomControl'),'TTabSet') do begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TCustomControl'),'TScroller') do begin
    RegisterMethod('Constructor Create( AOwner : TComponent)');
    RegisterMethod('Procedure Free');
...
procedure RIRegister_TTabSet(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TTabSet) do begin
    RegisterConstructor(@TTabSet.Create, 'Create');
    RegisterMethod(@TTabSet.Destroy, 'Free');
...
procedure RIRegister_TScroller(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TScroller) do begin
    RegisterConstructor(@TScroller.Create, 'Create');
    RegisterMethod(@TScroller.Destroy, 'Free');
