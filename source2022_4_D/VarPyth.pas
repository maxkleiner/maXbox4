...
begin
  ...
  // DispInvoke(Dest, Source, CallDesc, Params);
end;

type varUString  = ansistring;
  ...
  begin
    ...
    // value is a variant
      ...
      begin
        ...
        Inc(LStrCount);
        //{$J+}
        Inc(NativeInt(LParamPtr^), SizeOf(TVarData) - SizeOf(Pointer));   //fix
        //{$J-}
      end
      else
      begin
    ...
    begin
      ...
      case CVarTypeToElementInfo[LArgType].Size of
        ...
        begin
          ...
          Inc(NativeInt(LParamPtr^), 8 - SizeOf(Pointer));      //fix
        end;
      else
        RaiseDispError;
      end;
    end;
    Inc(NativeInt(LParamPtr^), SizeOf(Pointer));    //fix
  end;
